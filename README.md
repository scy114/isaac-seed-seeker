...
项目当前功能边界已经基本确定，不计划扩展为完整楼层、房间或掉落模拟器。后续只考虑以下方向：

- **每日爽种 / 每日毒种**：根据开局道具、属性与资源生成每日推荐，提供适合直接游玩的强力或折磨型伊甸开局；
- **种子反向解析**：输入八字符游戏种子，解析为内部数值种子，并展示当前 Profile 下的伊甸开局预测；
- **多人伊甸开局**：作为可能的大型扩展，研究同一种子下多名伊甸玩家的独立开局生成与组合筛选；在多人 RNG 顺序经过实机验证前不进入当前版本范围。
