...
“每日毒种”使用独立的每日种子序列。当前粗筛要求移速低于 `1.0`、射速低于 `3.0`、伤害低于 `3.0`。基础道具池只允许 Q0 主动和 Q0 被动，并额外放行主动道具 `33`、`38`、`45`、`298`、`522`、`639`、`729` 与被动道具 `149`、`222`、`329`、`529`、`561`。道具 `19`、`59`、`137`、`161` 被排除，道具 `721` 的候选权重为普通种子的 70%。页面同样支持换种和按需揭晓。
